...
-   `AWS_TOOLKIT_TEST_START_URL`: The start url you want to use on E2E tests
-   `AWS_TOOLKIT_TEST_START_URL_REGION`: The region for the start url you want to use on E2E tests
